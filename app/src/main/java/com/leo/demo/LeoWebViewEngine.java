 ...
 */
public class LeoWebViewEngine implements CordovaWebViewEngine {
    public static final String TAG = "LeoWebViewEngine";

    protected final LeoWebView webView;
    ...
    public LeoWebViewEngine(Context context, CordovaPreferences preferences) {
        this(new LeoWebView(context));
    }

    public LeoWebViewEngine(LeoWebView webView) {
    ...
    public void init(CordovaWebView parentWebView, CordovaInterface cordova, Client client, CordovaResourceApi resourceApi, PluginManager pluginManager, NativeToJsMessageQueue nativeToJsMessageQueue) {
        ...
        nativeToJsMessageQueue.addBridgeMode(new NativeToJsMessageQueue.OnlineEventsBridgeMode(new NativeToJsMessageQueue.OnlineEventsBridgeMode.OnlineEventsBridgeModeDelegate() {
            ...
            public void runOnUiThread(Runnable r) {
                LeoWebViewEngine.this.cordova.getActivity().runOnUiThread(r);
            }
        }));
    ...
    private static void exposeJsInterface(WebView webView, CordovaBridge bridge) {
        ...
        LeoExposedJsApi exposedJsApi = new LeoExposedJsApi(bridge);
