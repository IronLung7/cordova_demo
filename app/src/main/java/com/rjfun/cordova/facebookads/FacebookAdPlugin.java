...
public class FacebookAdPlugin extends GenericAdPlugin {
	...
	private static final String DEMO_ID = "762168197215104_783589628406294";
	//�ĳ��Լ���id�����bad request.
    private static final String TEST_BANNER_ID = DEMO_ID;
    private static final String TEST_INTERSTITIAL_ID = DEMO_ID;
    private static final String TEST_NATIVEAD_ID = DEMO_ID;
