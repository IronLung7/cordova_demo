...
public class WhitelistPlugin extends CordovaPlugin {
    ...
    public WhitelistPlugin(Context context) {
        ...
        new CustomConfigXmlParser().parse((Activity) context);
    }
    public WhitelistPlugin(XmlPullParser xmlParser) {
        this(new Whitelist(), new Whitelist(), null);
        new CustomConfigXmlParser().parse((XmlResourceParser) xmlParser);
    }
    ...
    public void pluginInitialize() {
        if (allowedNavigations == null) {
            ...
            allowedRequests = new Whitelist();
            new CustomConfigXmlParser().parse((Activity) webView.getContext());
        }
    }
